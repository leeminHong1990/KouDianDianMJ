...
var ResultUI = UIBase.extend({
    ...
    update_player_info: function (panle_idx, serverSitNum, finalPlayerInfo, win_idx, curGameRoom) {
        ...
        cur_player_info_panel.getChildByName("exposed_kong_label").setString(kong_num);
        cur_player_info_panel.getChildByName("concealed_kong_label").setString(finalPlayerInfo["concealed_kong"]);
        cur_player_info_panel.getChildByName("win_label").setString(finalPlayerInfo["win_times"]);
